    ...
    <div class="container">
                ...
                <div class="form-content">
                    ...
                    <div class="item-box">
                        ...
                        <div class="item-input-number">
                            <input v-model="anuncio.numeroTelefono" class="input-number" type="number">
                        </div>
                    </div>
                    ...
                    <div class="item-box">
                        ...
                        <div class="item-input">
                            <textarea v-model="anuncio.descripcion" id="" cols="30" rows="5"></textarea>
                        </div>
                    </div>             
                ...
                <div class="form-content">
                    ...
                    <div class="item-box">
                        ...
                        <div class="radio-container">
                            <div class="item-radio">
                                <input v-model="anuncio.telefono.estado" type="radio" value="nuevo" name="estado">
                                <span>Nuevo</span>
                            </div>
                            <div class="item-radio">
                                <input v-model="anuncio.telefono.estado" type="radio" value="usado" name="estado">
                                <span>Usado</span>
                            </div>
                        </div>
                    </div>   
                    ...
                    <div class="item-box">
                        ...
                        <div class="select-container">
                            <select v-model="anuncio.telefono.sistema" name="sistema" id="cars">
                    ...
                    <div class="item-box">
                        ...
                        <div class="item-input-number">
                            <input v-model="anuncio.telefono.precio" class="input-number" type="number">
                        </div>
                    </div>                
        ...
        <div class="second-line">
            <div class="title-content">
                <span align="center">Puedes subir un máximo de 4 imagenes por Anuncio</span>
            </div>            
                ...
                <div class="img-container">
                    <div class="img-box">
                        <div class="img-content">
                            <img :src="imagenes[contador] ? imagenes[contador].url : rutaImg" alt="" />
                        </div>
                ...
                <ul class="list-container">
                    ...
                    <li class="list-item" v-for="(img, index) in imagenes" :key="index">
                        <div class="list-item-content">
                            ...
                            <div class="list-item-icon" @click="borrarImagen(img.numero, index)">
    ...
    <div class="third-line">
        <div class="buttons-container">
            ...
            <div class="buttons-content">
                ...
                <router-link :to="{name: 'home'}" class="btn btnGeneral2">Cancelar</router-link>
...
onMounted(() => {
    ...
    getDownloadURL(reference(st, "anuncios/noImg/" + "blank-profile-picture-973460.svg")).then((url) => {
        rutaImg.value = url;
    });
});
...
const guardarAnuncio = async () => {
    ...
    if(anuncio.value.titulo !== "" && anuncio.value.vendedor !== "" && anuncio.value.numeroTelefono
    && anuncio.value.descripcion !== "" && anuncio.value.telefono.estado !== "" &&
    anuncio.value.telefono.modelo !== "" && anuncio.value.telefono.sistema !== "" && 
...
const guardarImagenes = async (id) => {
    ...
    for(let image of imagenes2.value){
        await uploadBytes(reference(st, "anuncios/" + id + "/" + numero), image).then((snapshot) => {
...
const handleFileUpload = async () => {
    if(imagenes.value.length < 4){
        ...
        await uploadBytes(reference(st, "anuncios/temporal/" + conteo.value), img.value.files[0]).then((snapshot) => {
            traerImagenTemp();
            img.value.value = '';
        });        
    }else {
...
const traerImagenTemp = async () => {
  await getDownloadURL(reference(st, "anuncios/temporal/" + conteo.value)).then((url) => {
